...
- **Extreme / posture expansion**: Runtime ExtremeMode flag implemented (Haskell). TUI :extreme on/off, gates groups/voice/contact-QR with hard refusal + messages. Decision recorded to implement scoped Extreme. Basic in TUI; full Rust/Android gating pending. See docs/EXTREME_PROFILE_DECISION.md and EXTREME_PROFILE.md.

...
**Tip:** `c542aff2103d76200928194d50c3c623464ce649`
...
The tip commit records `cargo test --lib` passing with 54 tests and a successful TUI build. Tests were not rerun for this documentation-only update.
...
- Persist network mode, DNS preference, and posture settings in the encrypted session state instead of process-local configuration.
- Make the Extreme profile a first-class TUI mode, including consistent gating of contact/link generation and other metadata surfaces.

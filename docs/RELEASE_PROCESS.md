...
#   This is now a REQUIRED artifact before any signed tag. The signed tag message should reference
#   that recent real-device + Tails/Qubes testing was performed and documented.

...
echo "[2/3] No Haskell. Protocol + TUI are Rust."
rm -f "$OUTPUT_DIR/haskell-deps.txt"
...
Primary Security Boundary: Rust (Double Ratchet, Argon2id, AES-GCM, Zeroize, framing, TUI, Tor SOCKS)

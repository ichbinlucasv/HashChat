...
echo "  # Phase1 queue observe (in any state): after sends, press 'i' -> sendQ=... recvQ=... lastRot=... (rotation active)"
echo ""
...
echo "  # For Phase1: after :file or many sends, capture with 'i' queue info visible in one shot"
echo ""
